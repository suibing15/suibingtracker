...
export default function ResetPasswordPage() {
  ...
  async function handleReset() {
    ...
    setStatus({ kind: "ok", msg: "Password updated — redirecting you to sign in…" });
    ...
    return (
      <main className="auth-wrap">
        <div className="auth-card">
          <p>Connect Supabase (env vars) first.</p>
        </div>
  ...
  return (
    <main className="auth-wrap">
      ...
      <div className="auth-card">
        ...
        {!ready ? (
          <p className="hint">Checking your reset link…</p>
        ) : !hasRecoverySession ? (
          <>
            <p className="hint">
          ...
          <>
            ...
            <button className="primary-btn" onClick={handleReset} disabled={status.kind === "busy"}>
              {status.kind === "busy" ? "Updating…" : "Update password"}
            </button>
